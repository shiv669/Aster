  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        className="shadow-inner relative flex h-12 items-center justify-center rounded-full bg-muted border border-border"
      >
        {!completed && (
          <motion.div
            style={{
          ...
          {!completed && (
            ...
            >
              <Button
                ...
                size="icon"
                className={cn(
                  "shadow-lg rounded-full drop-shadow-xl bg-primary text-primary-foreground h-14 w-14",
                  isDragging && "scale-105 transition-transform",
                  className
                )}
              >
                <SendHorizontal className="size-5 ml-1" />
              </Button>
            </motion.div>
          )}
        </AnimatePresence>
          ...
          {completed && (
            ...
            >
              <Button
                ...
                {...props}
                className={cn(
                  "size-full rounded-full transition-all duration-300 bg-primary text-primary-foreground",
                  className
                )}
              >
